  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span
            className="text-lg text-center border rounded-full border-white font-bold text-gray-900 mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity"
